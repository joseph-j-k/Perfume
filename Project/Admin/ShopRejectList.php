...
if(isset($_GET["accept"]))
{
	...
	if($conn -> query($update))
	{
		echo "<script>	
				alert('Accept');
			    window.location='ShopRejectList.php';
			  </script>";
...
<form id="form1" name="form1" method="post" action="">
  <table>
    ...
    <?php
	$i=0; 
	$sel = "select * from tbl_shop s inner join tbl_locality l on l.locality_id = s.shop_location inner join tbl_place p on p.place_id = l.place_id inner join tbl_district d on d.district_id = p.district_id where shop_status = '2' ";
    ...
    <tr>
      ...
      <td>
      <a href="ShopRejectList.php?accept=<?php echo $data['shop_id'] ?>">Accept</a>
      </td>
    </tr>
    <?php } ?>
  </table>
